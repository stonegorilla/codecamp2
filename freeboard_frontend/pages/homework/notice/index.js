...
export default function Homework(){
    ...
    const [writer, setWriter] = useState('dolwangsung')
    ...
    return (
        <Wrapper>
            ...
            <BodyWrapper>
                ...
                내용<ContentsInput type="textarea" onChange={onChangeContents}></ContentsInput>
                <button onClick={onClickSubmit}>데이터 입력하기</button>
            </BodyWrapper>
            <FootWrapper>
                2020 eatsroad Co..Ltd. All rights reserved.
            </FootWrapper>
        </Wrapper>
